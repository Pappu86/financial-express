...
<template>
  <footer class="bg-footer-bottom-light">
    <section class="py-4 xl:pt-14 xl:pb-4">
      ...
      >
        <div class="col-auto xl:col-span-6">
          <h4 class="font-bold text-xl">{{ $t('editor') }}: {{ $t('editor_name') }}</h4>
          <address class="mt-4 xl:text-lg font-semibold not-italic">{{ $t('published_info') }}</address>
          <p
            class="font-semibold text-base xl:text-lg mt-4"
          >{{ $t('PABX') }} : 02223389780 (Hunting)</p>
          <p class="font-semibold text-base xl:text-lg">
            {{ $t('mobile') }}:
            <a href="tel:+8801917231083">01917231083</a>
          </p>
          <p class="font-semibold text-base xl:text-lg">{{ $t('fax') }} : 880-2-02223387049</p>
          <!-- <p class="font-semibold text-base xl:text-lg">
            {{ $t('chattogram_office') }}:
            ...
            <tbody>
              <tr>
                ...
                <td class="font-semibold text-base xl:text-lg px-2">
                  {{ $t('email') }}:
                  <a
                    href="mailto:editor@thefinancialexpress.com.bd"
          ...
          <div class="grid grid-cols-2 xl:grid-cols-3 gap-4">
            <div class="col-auto xl:col-span-2 pt-4 xl:pt-0 space-y-3">
              <div class="flex flex-col xl:flex-row">
                <div class="xl:basis-1/2">
                  <h3 class="font-bold text-xl mb-4 uppercase">{{ $t('quick_links') }}</h3>
                  <ul class="space-y-2">
                ...
                <div class="xl:basis-1/2">
                  <h3 class="font-bold text-xl mb-4 hidden xl:block">--------</h3>
                  <ul class="space-y-2">
            ...
            <div class="col-auto xl:col-span-1 pt-4 xl:pt-0 space-y-3">
              ...
              <ul class="space-y-2">
                ...
                <li>
                  <a href="javascript:void(0)" @click="showTariff">{{ $t('menus.ad_tariff') }}</a>
                </li>
              </ul>
            </div>
          </div>
    ...
    <section class="pb-4 xl:pb-8">
      ...
      >
        <div class="col-auto xl:col-span-6 xl:mb-2">
          <h4 class="font-bold text-xl uppercase mb-2">{{ $t('newsletter.title') }}</h4>
    ...
    <section class="py-4">
      <v-container class="flex flex-wrap justify-between items-center text-p-dark opacity-90">
        ...
        <ul class="divide-x-2 grid grid-flow-col">
          <li v-for="menu in footerMenus" :key="menu.id" class="px-2">
            <nuxt-link :to="menu.slug" class="font-bold">{{ $t(getMenuStr(menu.title)) }}</nuxt-link>
          </li>
        </ul>
      </v-container>
    </section>
    <!--- Start top modal ads --->
    <div v-if="isTopModalAds" id="topPopupAd" class="top-popup popup-ad-modal">
      <v-top-modal-ads :ads="topModalAd"></v-top-modal-ads>
    </div>
    <!--- End top modal ads --->

    <!--- Start footer modal ads --->
    <div v-if="isFooterModalAds" id="footerPopupAd" class="footer-popup popup-ad-modal">
    ...
    >
      <div class="relative w-full h-full max-w-2xl md:h-auto">
        ...
        <div class="relative bg-green-500 rounded-lg shadow dark:bg-gray-700">
          <!-- Modal header -->
          <div class="flex items-start justify-between p-3 rounded-t dark:border-gray-600">
            <h4 class="text-xl font-semibold text-white-900 text-white">{{tostMessage}}</h4>
            <button
              type="button"
      ...
      <div class="relative w-full min-h-full md:max-w-5xl md:h-96">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Advertisement Tarrif</h3>
            <button
              type="button"
          ...
          <div class="p-6 space-y-6">
            <div class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
              <img src="~/assets/images/fe-tarriff/fe-tarriff.jpg" alt="FE Tarriff" />
            </div>
          </div>
        </div>
      </div>
