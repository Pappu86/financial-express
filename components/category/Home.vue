    ...
    <v-container>
      ...
      <div class="grid xl:grid-cols-15 gap-4">
          ...
          <article v-if="lead" class="grid grid-rows-3 xl:grid-rows-3">
            ...
            <div
              ...
              <div class="mt-24 xl:mt-40">
                ...
                <p class="text-p-light dark:text-p-dark text-base leading-6 line-clamp-2 mb-4" v-html="lead.excerpt"></p>
              </div>
            </div>
          </article>
        </section>
        ...
        <section class="col-auto xl:col-span-3">
          ...
          <client-only v-else>
            <Adsense data-ad-client="ca-pub-3438694616169600" data-ad-slot="3025948319" data-full-width-responsive="yes"
              is-new-ads-code="yes" data-ad-format="auto" ins-class="text-center mb-4" />
          </client-only>
        </section>
        <!-- column 2 -->
      </div>
