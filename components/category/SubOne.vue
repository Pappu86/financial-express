...
export default defineComponent({
  ...
  setup(props) {
    ...
    const fetch = async () => {
      ...
      try {
        const category: CategoryEconomy = await $axios.$get(
          `api/${lang}/category/${props.category}/bangladesh`
        )
    ...
    return {
      ...
      column6,
      column7,
      ads: computed(() => adsStore.adsChild1),
    }
  },
})
</script>
...
<template>
  <div id="sub-category-one" ref="target" class="bg-bg2-light dark:bg-bg2-dark py-8">
    <v-container>
      <!-- heading -->
      <category-heading name="Bangladesh" :url="to" />
      <!-- heading -->
      ...
      <div class="grid xl:grid-cols-15 gap-4 pb-4">
        ...
        <section class="col-auto xl:col-span-6">
          <article v-if="lead" class="grid grid-rows-4">
            ...
            <div
              class="bg-bg1-light dark:bg-bg1-dark px-4 xl:px-16 pb-4 xl:pb-8 text-center row-span-5 xl:row-span-3 row-start-2 xl:row-start-2 col-span-full grid place-content-end">
              <div class="-mt-40 xl:-mt-64">
                ...
                <p class="text-p-light dark:text-p-dark text-base leading-6 line-clamp-3" v-html="lead.excerpt"></p>
              </div>
            </div>
          </article>
        </section>
          ...
          <article v-if="leadBottom" class="grid grid-rows-5 xl:grid-rows-5">
            ...
            <div
              ...
              <div class="-mt-72 xl:-mt-72">
                ...
                <p class="text-p-light dark:text-p-dark text-base leading-6 line-clamp-3 mt-4">
                  {{ leadBottom.excerpt }}
                </p>
              </div>
            </div>
